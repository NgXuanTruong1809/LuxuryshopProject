                        ...
                        <div class="row">
                            <div class="col-xl-5 col-lg-7 col-md-8">
                                <div class="hero__text">
                                    ...
                                    <a href="/shop-search?page=1" class="primary-btn">Khám phá ngay
                                    </a>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="categories__hot__deal">
                        <img src="/file/upload/sofa-da-italia-impressive-3-cho-72608054.jpg" alt="">
                ...
                <div class="col-lg-4 offset-lg-1">
                    <div class="categories__deal__countdown">
                        ...
                        <a href="/shop-details/sofa-da-italia-impressive-1637119467265" class="primary-btn">Mua ngay</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row hihi">
                ...
                <div>
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            <h6>{{$product->title}}</h6>
                            <a href="javascript:void(0)" class="add-cart" onclick="cart.choose_product_to_cart({{$product->id}}, 1);">+  giỏ hàng</a>
                            <p style="Display:none" id="numm">{{$quant}}</p>
