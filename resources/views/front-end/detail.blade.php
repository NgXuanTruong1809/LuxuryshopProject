...
<head>
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v16.0" nonce="iYPXv0nF"></script>
...
@include('front-end.common.header')
    ...
    <div class="container">
            <div class="row">
                ...
                <div class="fb-comments" data-href="http://localhost:8001/" data-width="" data-numposts="5"></div>
